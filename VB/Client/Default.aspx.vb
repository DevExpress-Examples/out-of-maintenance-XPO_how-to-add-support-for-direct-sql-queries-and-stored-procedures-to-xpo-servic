...
Partial Public Class _Default
	...
	Protected Sub Page_Init(ByVal sender As Object, ByVal e As EventArgs)
		...
		ordersView.DataSource = session.GetObjectsByKeyFromSproc(session.GetClassInfo(Of Order)(), True, "CustomerOrders", New OperandValue(customerId))
	End Sub

	Protected Sub OnOrdersViewCustomCallback(ByVal sender As Object, ByVal args As ASPxGridViewCustomCallbackEventArgs)
